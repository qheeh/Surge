...
### 2. 模块安装链接
> **稳定版 :** https://raw.githubusercontent.com/qheeh/Surge/main/Module/Panel/Panel/panel.sgmodule<br>
...
(检查方式为 Surge -> 脚本 -> 脚本编辑器 -> 载入 -> Panel -> 检查代码是否与网页版本相同**
